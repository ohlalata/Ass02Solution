            ...
            try
            {
                if (IsAdminLogin)
                {
                    if (InsertOrUpdate)
                    {
                        ...
                        if (productPresenter.ProductName == String.Empty)
                        {
                            throw new FormatException("Product name can't empty!");
                        }
                        else if (productPresenter.CategoryName == String.Empty)
                        {
                            throw new FormatException("Category name can't empty!");
                        }
                        else if (productPresenter.Weight == String.Empty)
                        {
                            throw new FormatException("Weight can't empty!");
                        }
                        else if (productPresenter.UnitPrice <= 0)
                        {
                            throw new FormatException("Units price must be greater than 0");
                        }
                        else if (productPresenter.UnitsInStock <= 0)
                        {
                            throw new FormatException("Units in stock must be greater than 0");
                        }
                        else
                        {
